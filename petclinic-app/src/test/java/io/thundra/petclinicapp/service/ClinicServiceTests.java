...
package io.thundra.petclinicapp.service;
...
import io.thundra.petclinicapp.vet.Vet;
import io.thundra.petclinicapp.vet.VetRepository;
import io.thundra.petclinicapp.visit.Visit;
import io.thundra.petclinicapp.visit.VisitRepository;
import org.assertj.core.api.Assertions;
import org.junit.jupiter.api.Test;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.test.autoconfigure.orm.jpa.DataJpaTest;
import io.thundra.petclinicapp.owner.Owner;
import io.thundra.petclinicapp.owner.OwnerRepository;
...
class ClinicServiceTests {
	...
	void shouldFindVets() {
		...
		Assertions.assertThat(vet.getSpecialties().get(0).getName()).isEqualTo("dog");
		Assertions.assertThat(vet.getSpecialties().get(1).getName()).isEqualTo("lizard");
	}
